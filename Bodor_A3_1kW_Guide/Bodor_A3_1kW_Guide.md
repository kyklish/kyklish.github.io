...
7. Разместить детали на листе (**Nest -> Do nesting...**):
    ...
    2. Задать отступ от края листа (обпил) (*Plate Margin*): 10мм (если меньше, сопло головы может удариться об упоры для листа на рабочем столе!!!). Можно уменьшить до 5мм (если очень нужно, например разместить две двери по 600мм с *CoEdge* на стандартный лист).
...
![](./Image/NestCoEdgeSelected.png)

![](./Image/CoEdgePoint.png)
...
18. Риска для приварки петли: обычная гравировка. Нужно гравировать все риски сразу, одна за одной. Если буде чередование обычной резки и гравировки, то риски могут получиться блеклыми. Можно попробовать прибавить мощности: 1-3%.
