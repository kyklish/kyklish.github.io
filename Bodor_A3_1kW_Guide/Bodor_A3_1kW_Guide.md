...
3. Зажать **Ctrl** чтобы повернуть деталь, **Alt** чтобы растянуть или сжать деталь.
...
9. **Edge Finding**:
   ...
   2. *Rack Clearance*: расстояние между вершинами зубьев на ламели? (Rack это точно зуб).
   3. *Back Distance*: расстояние между ламелями?
