...
1. **Set Origin** ![](./Button/SetOrigin.png) - установить ноль *рабочих* координат. Ноль для всех деталей переместится в абсолютные (текущие) координаты головы.
...
**ДЕТАЛЬ ПОКАЗАНА В НАЧАЛЕ КООРДИНАТ РАБОЧЕГО СТОЛА, НО ФАКТИЧЕСКИ ОНА БУДЕТ ВЫРЕЗАТЬСЯ С ТЕКУЩИХ КООРДИНАТ ГОЛОВЫ!!!**
