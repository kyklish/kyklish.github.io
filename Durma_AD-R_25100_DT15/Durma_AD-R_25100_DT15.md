...
1. Все параметры матрицы и пуансона указаны на самом инструменте.
...
1. Параметр **Safety** равен половине раскрытия матрицы **Open (O)**.
1. Параметр **Forbidden (P)** равен половине ширины матрицы **Width (W)**.
